...
Most of these come down to network reality or how bibleapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

bibleapi rate-limits like any public site. bibleapi already paces
...
Where a surface is gated, bibleapi reads a cookie or token you supply
...
`bibleapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bibleapi actually did
